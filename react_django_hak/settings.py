"""
Django settings for react_django_hak project.
...
SECRET_KEY = 'django-insecure-@61*2k^#!r$^$o=oz&sv^#&^1k72)ku+zc+27n$k69d+2d(gj*'
...
ROOT_URLCONF = 'react_django_hak.urls'
...
WSGI_APPLICATION = 'react_django_hak.wsgi.application'
